                ...
                ?>
                  ...
                  <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                          ...
                          <div class="card-flyer">
                              <div class="text-box">
                                  <div class="image-box">
                                      <img src="hms/images/<?php echo $row['proimg'];?>" alt="bananabread" />
                                  </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                    <a href="">
                        <div class="card-flyer">
                            <div class="text-box">
                                <div class="image-box">
                                    <img src="hms/images/<?php echo $row['proimg'];?>" alt="cake" />
                                </div>
                                <div class="text-container">
                                    <h6><?php echo $row['proname'];?></h6>
                                    <p>Rs. <?php echo $row['proprice'];?></p>
              ...
              <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                  <a href="">
                      <div class="card-flyer">
                          <div class="text-box">
                              <div class="image-box">
                                  <img src="hms/images/<?php echo $row['proimg'];?>" alt="italianpasta" />
                              </div>
                              <div class="text-container">
                                  <h6><?php echo $row['proname'];?></h6>
                                  <p>Rs. <?php echo $row['proprice'];?></p>
